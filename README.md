...
![Figure 1 - Register Page](assets/images/RegistePage.png)

**Figure 2: Login Page**  
Users can log in to the system using their registered email and password.

![Figure 2 - Login Page](assets/images/Login.png)
